...
export function pricesCategoriesKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
    ...
    .text("📜 Hujjat", "ap:price:price_document")
    .row()
    .text("🥷 Geroy yaratish", "ap:price:price_hero_create")
    .text("⭐️ VIP", "ap:price:price_vip_month")
    .row()
    .text("⭐ Geroy ball (1k)", "ap:price:price_hero_points_1000")
    .text("🛡 Geroy himoya", "ap:price:price_hero_prot")
    .row()
    .text("⚡ Geroy zaryad", "ap:price:price_hero_charge")
    .row()
    .text("🗃 Sandiq (Basic)", "ap:price:price_chest_basic")
    .text("🗃 Sandiq (Silver)", "ap:price:price_chest_silver")
    .row()
    .text("🗃 Sandiq (Gold)", "ap:price:price_chest_gold")
    .row()
    .text("💎 Olmos komissiyasi", "ap:price:fee_diamond")
    .text("💰 Pul komissiyasi", "ap:price:fee_money")
    .row()
    .text("🎭 Aktiv rollar", "ap:roleprices")
    .row()
    .text("🔙 Asosiy", "ap:main");
}
