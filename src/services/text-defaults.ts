...
export const TEXT_DEFAULTS: Record<string, string> = {
  ...
  "errors.playerBlocked": "💃 Sizni bu tunda uxlatishgan! Bugun kunduzi hech narsa qila olmaysiz — ovoz berish, hujum va yozish taqiqlangan.",
...
export const TEXT_LABELS: Record<string, string> = {
  ...
  "errors.playerBlocked": "Xato — Kezuvchi uxlatgan (kunduzi hech narsa qila olmaydi)",
